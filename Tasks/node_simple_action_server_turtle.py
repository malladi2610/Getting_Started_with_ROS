...
class SimpleActionServerTurtle:
    ...
    def func_move_straight(self, param_dis, param_speed, param_dir):
        ...
        while not rospy.is_shutdown():
            ...
            obj_msg_feedback.cur_x = int(self._curr_x)
            obj_msg_feedback.cur_y = int(self._curr_y)
            obj_msg_feedback.cur_theta = int(self._curr_theta)
    ...
    def func_on_rx_goal(self, obj_msg_goal):
        ...
        parameters = {"id":"Sheet1", "x_val":self._curr_x, "y_val":self._curr_y, "theta":self._curr_theta} 
        URL = "https://script.google.com/macros/s/AKfycbyVCkXkK2N43qrm8KexStN_ljpRJn-Om02Znz2Mu9oRlj0giIC5/exec"
...
#def google_ap(self, *pose_message):
    #self._curr_x = pose_message.x
   # self._curr_y = pose_message.y
   # self._curr_theta = pose_message.theta
  #  parameters = {"id":"Sheet1", "x_val":self._curr_x, "y_val":self._curr_y, "theta":self._curr_theta} 
